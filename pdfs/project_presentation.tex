...
% ----------------------------------------------------------
% Appendix: Additional scenario comparisons
% ----------------------------------------------------------
\begin{frame}{Backup: Additional MILP vs Langevin EBM Comparisons}
...
\begin{itemize}
  \item Exact cost recovery in multiple regimes
  \item Consistent dispatch, storage dynamics and slack activation
\end{itemize}
\end{block}
